...
class PlgSystemCDScriptegratorLibraryCLEditor
{
	...
	{		
		...
		$editor_options[] = 'controls : "' . (string) $this->plg_params->get( 'editor_controls', 'bold italic underline strikethrough subscript superscript | font size style | color highlight removeformat | bullets numbering | outdent indent | alignleft center alignright justify | undo redo | rule image link unlink | cut copy paste pastetext | print source | icon' ) . '"';
