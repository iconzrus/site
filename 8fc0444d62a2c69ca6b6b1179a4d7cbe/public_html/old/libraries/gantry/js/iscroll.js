 ...
 */
function iScroll(c,a){this.element=typeof c=="object"?c:document.getElementById(c);this.wrapper=this.element.parentNode;this.wrapper.style.position="relative";
...
window.addEventListener("orientationchange",this);}iScroll.prototype={_x:0,_y:0,handleEvent:function(a){switch(a.type){case"touchstart":this.onTouchStart(a);
...
b=e;}if(g<0&&d!==undefined&&b>d){c=c*d/b;b=d;}b=b*(g<0?-1:1);var a=-c/-deceleration;if(a<1){a=1;}return{dist:Math.round(b),time:Math.round(a)};}};var scrollbar=function(a,b){this.dir=a;
...
this.bar.style.opacity="0";b.appendChild(this.bar);};scrollbar.prototype={size:0,maxSize:0,maxScroll:0,visible:false,init:function(a,b){var c=this.dir=="horizontal"?this.bar.offsetWidth-this.bar.clientWidth:this.bar.offsetHeight-this.bar.clientHeight;
