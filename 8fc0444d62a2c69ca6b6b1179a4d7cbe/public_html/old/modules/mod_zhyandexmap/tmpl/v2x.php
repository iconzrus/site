...
if (isset($map->lang) && $map->lang != "")
{
	...
	$currentLanguage->load('mod_zhyandexmap', JPATH_COMPONENT, $map->lang, true);	
}
...
if (isset($map->usermarkers) && (int)$map->usermarkers == 1) 
{
    ...
    if ($currentUser->id == 0)
    {
		$currentUserInfo .= JText::_( 'MOD_ZHYANDEXMAP_MAP_USER_NOTLOGIN' );
		$allowUserMarker = 0;
		$currentUserID = 0;
    ...
    {
		$currentUserInfo .= JText::_( 'MOD_ZHYANDEXMAP_MAP_USER_LOGIN' ) .' '. $currentUser->name;
		$allowUserMarker = 1;
				...
				if (isset($showuser) && ((int)$showuser != 0))
				{
					switch ((int)$showuser) 
					{
						case 1:
							if ($cur_user_name != "") 
							{
								$cur_scripttext .= '\'<p class="placemarkBodyUser">'.JText::_('MOD_ZHYANDEXMAP_MAP_USER_USER_NAME').' '.htmlspecialchars(str_replace('\\', '/', $cur_user_name), ENT_QUOTES, 'UTF-8').'</p>\'+'."\n";
							}
							if ($cur_user_address != "") 
							{
								$cur_scripttext .= '\'<p class="placemarkBodyUser">'.JText::_('MOD_ZHYANDEXMAP_MAP_USER_USER_ADDRESS').' '.str_replace('<br /><br />', '<br />',str_replace(array("\r", "\r\n", "\n"), '<br />', htmlspecialchars(str_replace('\\', '/', $cur_user_address), ENT_QUOTES, 'UTF-8'))).'</p>\'+'."\n";
							}
							if ($cur_user_phone != "") 
							{
								$cur_scripttext .= '\'<p class="placemarkBodyUser">'.JText::_('MOD_ZHYANDEXMAP_MAP_USER_USER_PHONE').' '.htmlspecialchars(str_replace('\\', '/', $cur_user_phone), ENT_QUOTES, 'UTF-8').'</p>\'+'."\n";
							}
						break;
						case 2:
							if ($cur_user_name != "") 
							...
							if ($cur_user_address != "") 
							{
								$cur_scripttext .= '\'<p class="placemarkBodyUser"><img src="'.$imgpathUtils.'address.png" alt="'.JText::_('MOD_ZHYANDEXMAP_MAP_USER_USER_ADDRESS').'" />'.str_replace('<br /><br />', '<br />',str_replace(array("\r", "\r\n", "\n"), '<br />', htmlspecialchars(str_replace('\\', '/', $cur_user_address), ENT_QUOTES, 'UTF-8'))).'</p>\'+'."\n";
							}
							if ($cur_user_phone != "") 
							{
								$cur_scripttext .= '\'<p class="placemarkBodyUser"><img src="'.$imgpathUtils.'phone.png" alt="'.JText::_('MOD_ZHYANDEXMAP_MAP_USER_USER_PHONE').'" />'.htmlspecialchars(str_replace('\\', '/', $cur_user_phone), ENT_QUOTES, 'UTF-8').'</p>\'+'."\n";
							}
						break;
						case 3:
							if ($cur_user_name != "") 
...
if (isset($map->findcontrol) && (int)$map->findcontrol == 1) 
{
	switch ((int)$map->findpos) 
	{
		...
		case 0:
			...
			{
				$divmapbefore .= JText::_( 'MOD_ZHYANDEXMAP_MAP_DOFINDBUTTONROUTE' );
			}
			else
			{
				$divmapbefore .= JText::_( 'MOD_ZHYANDEXMAP_MAP_DOFINDBUTTON' );
			}
			$divmapbefore .= '" />'."\n";
		...
		case 102:
			...
			if (isset($map->findroute) && (int)$map->findroute == 1) 
			{
				$divmapafter .= JText::_( 'MOD_ZHYANDEXMAP_MAP_DOFINDBUTTONROUTE' );
			}
			else
			{
				$divmapafter .= JText::_( 'MOD_ZHYANDEXMAP_MAP_DOFINDBUTTON' );
			}
			$divmapafter .= '" />'."\n";
			//$divmapafter .= '</p>'."\n";
			$divmapafter .= '</form>'."\n";
...
if (isset($map->autopositioncontrol) && (int)$map->autopositioncontrol == 2) 
{
	...
	switch ((int)$map->autopositionpos) 
	{
		...
		case 0:
			...
			{
				case 1:
					$divmapbefore .= '<img src="'.$imgpathUtils.'geolocation.png" alt="'.JText::_('MOD_ZHYANDEXMAP_MAP_AUTOPOSITIONBUTTON').'" style="vertical-align: middle">';
				break;
				case 2:
					$divmapbefore .= JText::_('MOD_ZHYANDEXMAP_MAP_AUTOPOSITIONBUTTON');
				break;
				case 3:
					$divmapbefore .= '<img src="'.$imgpathUtils.'geolocation.png" alt="'.JText::_('MOD_ZHYANDEXMAP_MAP_AUTOPOSITIONBUTTON').'" style="vertical-align: middle">';
					$divmapbefore .= JText::_('MOD_ZHYANDEXMAP_MAP_AUTOPOSITIONBUTTON');
		...
		case 102:
			...
			{
				case 1:
					$divmapafter .= '<img src="'.$imgpathUtils.'geolocation.png" alt="'.JText::_('MOD_ZHYANDEXMAP_MAP_AUTOPOSITIONBUTTON').'" style="vertical-align: middle">';
				break;
				case 2:
					$divmapafter .= JText::_('MOD_ZHYANDEXMAP_MAP_AUTOPOSITIONBUTTON');
				break;
				case 3:
					$divmapafter .= '<img src="'.$imgpathUtils.'geolocation.png" alt="'.JText::_('MOD_ZHYANDEXMAP_MAP_AUTOPOSITIONBUTTON').'" style="vertical-align: middle">';
					$divmapafter .= JText::_('MOD_ZHYANDEXMAP_MAP_AUTOPOSITIONBUTTON');
...
$scripttext .= '<script type="text/javascript" >/*<![CDATA[*/' ."\n";
	...
	if ((int)$map->openstreet == 1)
	{
		...
		$credits .= 'OSM '.JText::_('MOD_ZHYANDEXMAP_MAP_POWEREDBY').': ';
	...
	if (isset($map->mapbounds) && $map->mapbounds != "")
	{
		...
		{
			$scripttext .= 'alert("'.JText::_('MOD_ZHYANDEXMAP_MAP_ERROR_MAPBOUNDS').'");'."\n";
		}
		else
		{
	...
	if (isset($map->toolbar) && (int)$map->toolbar == 1) 
	{
		...
		if (isset($map->autopositioncontrol) && (int)$map->autopositioncontrol == 1) 
		{
				...
				{
					case 1:
						$scripttext .= 'var btnGeoPosition = new ymaps.control.Button({ data: { image: "'.$imgpathUtils.'geolocation.png", content: "", title: "'.JText::_('MOD_ZHYANDEXMAP_MAP_AUTOPOSITIONBUTTON').'"}});' ."\n";
					break;
					case 2:
						$scripttext .= 'var btnGeoPosition = new ymaps.control.Button({ data: { content: "'.JText::_('MOD_ZHYANDEXMAP_MAP_AUTOPOSITIONBUTTON').'", title: "'.JText::_('MOD_ZHYANDEXMAP_MAP_AUTOPOSITIONBUTTON').'"}});' ."\n";
					break;
					case 3:
						$scripttext .= 'var btnGeoPosition = new ymaps.control.Button({ data: { image: "'.$imgpathUtils.'geolocation.png", content: "'.JText::_('MOD_ZHYANDEXMAP_MAP_AUTOPOSITIONBUTTON').'", title: "'.JText::_('MOD_ZHYANDEXMAP_MAP_AUTOPOSITIONBUTTON').'"}});' ."\n";
					break;
					default:
						$scripttext .= 'var btnGeoPosition = new ymaps.control.Button({ data: { image: "'.$imgpathUtils.'geolocation.png", content: "", title: "'.JText::_('MOD_ZHYANDEXMAP_MAP_AUTOPOSITIONBUTTON').'"}});' ."\n";
					break;
		...
		if (isset($map->markerlistpos) && (int)$map->markerlistpos != 0) 
		{
			...
			else
			{
				...
				else
				{
						...
						{
							case 1:
								$scripttext .= 'var btnPlacemarkList = new ymaps.control.Button({ data: { image: "'.$imgpathUtils.'star.png", content: "", title: "'.JText::_('MOD_ZHYANDEXMAP_MAP_PLACEMARKLIST').'"}});' ."\n";
							break;
							case 2:
								$scripttext .= 'var btnPlacemarkList = new ymaps.control.Button({ data: { content: "'.JText::_('MOD_ZHYANDEXMAP_MAP_PLACEMARKLIST').'", title: "'.JText::_('MOD_ZHYANDEXMAP_MAP_PLACEMARKLIST').'"}});' ."\n";
							break;
							case 11:
								$scripttext .= 'var btnPlacemarkList = new ymaps.control.Button({ data: { image: "'.$imgpathUtils.'star.png", content: "", title: "'.JText::_('MOD_ZHYANDEXMAP_MAP_PLACEMARKLIST').'"}});' ."\n";
							break;
	...
	if (isset($licenseinfo) && (int)$licenseinfo != 0) 
	{
		  ...
		  ) 
		{
			...
			$credits .= ''.JText::_('MOD_ZHYANDEXMAP_MAP_POWEREDBY').': ';
			$credits .= '<a href="http://www.zhuk.cc/" target="_blank" alt="'.JText::_('MOD_ZHYANDEXMAP_MAP_POWEREDBY').'">zhuk.cc</a>';
		}
		else
		{
		}
	...
	*/
	...
	if ($allowUserMarker == 1)
	{
		...
		$scripttext .= 'insertPlacemark.properties.set("balloonContentHeader", "'.JText::_( 'MOD_ZHYANDEXMAP_MAP_USER_NEWMARKER' ).'");' ."\n";
		$scripttext .= 'insertPlacemark.properties.set("balloonContentBody", "'.JText::_( 'MOD_ZHYANDEXMAP_MAP_USER_NEWMARKER_DESC' ).'");' ."\n";
		...
		$scripttext .= '\'<h1 id="headContentInsertPlacemark" class="insertPlacemarkHead">'.
			...
			JText::_( 'MOD_ZHYANDEXMAP_MAP_USER_NEWMARKER' ).'</h1>\'+' ."\n";
		$scripttext .= '\'<div id="bodyContentInsertPlacemark"  class="insertPlacemarkBody">\'+'."\n";
		//$scripttext .= '    \''.JText::_( 'MOD_ZHYANDEXMAP_MAP_USER_LNG' ).' \'+insertPlacemarkLocation.getLng() + ' ."\n";
		//$scripttext .= '    \'<br />'.JText::_( 'MOD_ZHYANDEXMAP_MAP_USER_LAT' ).' \'+insertPlacemarkLocation.getLat() + ' ."\n";
		...
		$scripttext .= '\'<a id="bodyInsertPlacemarkA" href="javascript:showonlyone(\\\'Placemark\\\',\\\'\\\');" ><img src="'.$imgpathUtils.'collapse.png">'.JText::_( 'MOD_ZHYANDEXMAP_MAP_USER_BASIC_PROPERTIES' ).'</a>\'+'."\n";
		$scripttext .= '\'</div>\'+'."\n";
		$scripttext .= '\'<div id="bodyInsertPlacemark"  class="bodyInsertPlacemarkProperties">\'+'."\n";
		$scripttext .= '    \''.JText::_( 'MOD_ZHYANDEXMAP_MAP_USER_NAME' ).' \'+' ."\n";
		$scripttext .= '    \'<br />\'+' ."\n";
		$scripttext .= '    \'<input name="markername" type="text" maxlength="250" size="50" />\'+' ."\n";
		$scripttext .= '    \'<br />\'+' ."\n";
		$scripttext .= '    \''.JText::_( 'MOD_ZHYANDEXMAP_MAP_USER_DESCRIPTION' ).' \'+' ."\n";
		$scripttext .= '    \'<br />\'+' ."\n";
		$scripttext .= '    \'<input name="markerdescription" type="text" maxlength="250" size="50" />\'+' ."\n";

		$scripttext .= '    \'<br />\'+' ."\n";
		$scripttext .= '    \''.JText::_( 'MOD_ZHYANDEXMAP_MAPMARKER_DETAIL_HREFIMAGE_LABEL' ).' \'+' ."\n";
		$scripttext .= '    \'<br />\'+' ."\n";
		...
		if (isset($map->usermarkersicon) && (int)$map->usermarkersicon == 1) 
		{
			...
			$scripttext .= '    \''.JText::_( 'MOD_ZHYANDEXMAP_MAP_USER_ICON_TYPE' ).' \'+' ."\n";
			$scripttext .= ' \'';
			...
			$scripttext .= str_replace('.png<', '<', 
								str_replace('.png"', '"', 
									str_replace('JOPTION_SELECT_IMAGE', JText::_('MOD_ZHYANDEXMAP_MAP_USER_IMAGESELECT'),
		...
		if (isset($map->showbelong) && (int)$map->showbelong == 1)
		{
			...
			$scripttext .= '\'<a id="bodyInsertPlacemarkGrpA" href="javascript:showonlyone(\\\'PlacemarkGroup\\\',\\\'\\\');" ><img src="'.$imgpathUtils.'expand.png">'.JText::_( 'MOD_ZHYANDEXMAP_MAP_USER_BASIC_GROUP_PROPERTIES' ).'</a>\'+'."\n";
			$scripttext .= '\'</div>\'+'."\n";
			$scripttext .= '\'<div id="bodyInsertPlacemarkGrp"  class="bodyInsertPlacemarkGrpProperties">\'+'."\n";
			$scripttext .= '    \''.JText::_( 'MOD_ZHYANDEXMAP_MAP_USER_GROUP' ).' \'+' ."\n";
			$scripttext .= '    \'<br />\'+' ."\n";
			
			$scripttext .= '    \' <select name="markergroup" > \'+' ."\n";
			$scripttext .= '    \' <option value="" selected="selected">'.JText::_( 'MOD_ZHYANDEXMAP_MAPMARKER_FILTER_PLACEMARK_GROUP').'</option> \'+' ."\n";
			...
			$scripttext .= '    \''.JText::_( 'MOD_ZHYANDEXMAP_MAP_USER_CATEGORY' ).' \'+' ."\n";
			$scripttext .= '    \'<br />\'+' ."\n";
			$scripttext .= '    \' <select name="markercatid" > \'+' ."\n";
			$scripttext .= '    \' <option value="" selected="selected">'.JText::_( 'MOD_ZHYANDEXMAP_MAP_FILTER_CATEGORY').'</option> \'+' ."\n";
		...
		if (isset($map->usercontact) && (int)$map->usercontact == 1) 
		{
				...
				$scripttext .= '\'<a id="bodyInsertContactA" href="javascript:showonlyone(\\\'Contact\\\',\\\'\\\');" ><img src="'.$imgpathUtils.'expand.png">'.JText::_( 'MOD_ZHYANDEXMAP_MAP_USER_CONTACT_PROPERTIES' ).'</a>\'+'."\n";
				$scripttext .= '\'</div>\'+'."\n";
				...
				$scripttext .= '    \''.JText::_( 'MOD_ZHYANDEXMAP_MAP_USER_CONTACT_NAME' ).' \'+' ."\n";
				$scripttext .= '    \'<br />\'+' ."\n";
				$scripttext .= '    \'<input name="contactname" type="text" maxlength="250" size="50" />\'+' ."\n";
				$scripttext .= '    \'<br />\'+' ."\n";
				$scripttext .= '    \''.JText::_( 'MOD_ZHYANDEXMAP_MAP_USER_CONTACT_POSITION' ).' \'+' ."\n";
				$scripttext .= '    \'<br />\'+' ."\n";
				$scripttext .= '    \'<input name="contactposition" type="text" maxlength="250" size="50" />\'+' ."\n";
				$scripttext .= '    \'<br />\'+' ."\n";
				$scripttext .= '    \''.JText::_( 'MOD_ZHYANDEXMAP_MAP_USER_CONTACT_PHONE' ).' \'+' ."\n";
				$scripttext .= '    \'<br />\'+' ."\n";
				$scripttext .= '    \'<input name="contactphone" type="text" maxlength="250" size="50" />\'+' ."\n";
				$scripttext .= '    \'<br />\'+' ."\n";
				$scripttext .= '    \''.JText::_( 'MOD_ZHYANDEXMAP_MAP_USER_CONTACT_MOBILE' ).' \'+' ."\n";
				$scripttext .= '    \'<br />\'+' ."\n";
				$scripttext .= '    \'<input name="contactmobile" type="text" maxlength="250" size="50" />\'+' ."\n";
				$scripttext .= '    \'<br />\'+' ."\n";
				$scripttext .= '    \''.JText::_( 'MOD_ZHYANDEXMAP_MAP_USER_CONTACT_FAX' ).' \'+' ."\n";
				$scripttext .= '    \'<br />\'+' ."\n";
				...
				$scripttext .= '\'<a id="bodyInsertContactAdrA" href="javascript:showonlyone(\\\'ContactAddress\\\',\\\'\\\');" ><img src="'.$imgpathUtils.'expand.png">'.JText::_( 'MOD_ZHYANDEXMAP_MAP_USER_CONTACT_ADDRESS_PROPERTIES' ).'</a>\'+'."\n";
				$scripttext .= '\'</div>\'+'."\n";
				$scripttext .= '\'<div id="bodyInsertContactAdr"  class="bodyInsertContactAdrProperties">\'+'."\n";
				$scripttext .= '    \''.JText::_( 'MOD_ZHYANDEXMAP_MAP_USER_CONTACT_ADDRESS' ).' \'+' ."\n";
				$scripttext .= '    \'<br />\'+' ."\n";
		...
		$scripttext .= '    \'<input name="markersubmit" type="submit" value="'.JText::_( 'MOD_ZHYANDEXMAP_MAP_USER_BUTTON_ADD' ).'" />\'+' ."\n";
		$scripttext .= '    \'</form>\'+' ."\n";		
		$scripttext .= '\'</div>\'+'."\n";
		$scripttext .= '\'</div>\';'."\n";
	...
	if (isset($map->markerlistpos) && (int)$map->markerlistpos != 0) 
	{
		if ((int)$map->markerlistcontent < 100) 
		{
			...
			$scripttext .= '{'."\n";
			$scripttext .= ' alert("'.JText::_('MOD_ZHYANDEXMAP_MAP_MARKERUL_NOTFIND').'");'."\n";
			$scripttext .= '}'."\n";
		}
		else
		{
			...
			$scripttext .= 'if (!markerUL)'."\n";
			$scripttext .= '{'."\n";
			$scripttext .= ' alert("'.JText::_('MOD_ZHYANDEXMAP_MAP_MARKERTABLE_NOTFIND').'");'."\n";
			$scripttext .= '}'."\n";
		}
		...
		foreach ($markers as $key => $currentmarker) 
		{
				   ...
				   )
				{
									...
									if (isset($currentmarker->showcontact) && ((int)$currentmarker->showcontact != 0))
									{
										switch ((int)$currentmarker->showcontact) 
										{
											case 1:
												...
												{
													$scripttext .= '\'<p class="placemarkBodyContact">'.JText::_('MOD_ZHYANDEXMAP_MAP_USER_CONTACT_NAME').' '.htmlspecialchars(str_replace('\\', '/', $currentmarker->contact_name), ENT_QUOTES, 'UTF-8').'</p>\'+'."\n";
												}
												if ($currentmarker->contact_position != "") 
												{
													$scripttext .= '\'<p class="placemarkBodyContact">'.JText::_('MOD_ZHYANDEXMAP_MAP_USER_CONTACT_POSITION').' '.htmlspecialchars(str_replace('\\', '/', $currentmarker->contact_position), ENT_QUOTES, 'UTF-8').'</p>\'+'."\n";
												}
												if ($currentmarker->contact_address != "") 
												{
													$scripttext .= '\'<p class="placemarkBodyContact">'.JText::_('MOD_ZHYANDEXMAP_MAP_USER_CONTACT_ADDRESS').' '.str_replace('<br /><br />', '<br />', str_replace(array("\r", "\r\n", "\n"), '<br />', htmlspecialchars(str_replace('\\', '/', $currentmarker->contact_address), ENT_QUOTES, 'UTF-8'))).'</p>\'+'."\n";
												}
												if ($currentmarker->contact_phone != "") 
												{
													$scripttext .= '\'<p class="placemarkBodyContact">'.JText::_('MOD_ZHYANDEXMAP_MAP_USER_CONTACT_PHONE').' '.htmlspecialchars(str_replace('\\', '/', $currentmarker->contact_phone), ENT_QUOTES, 'UTF-8').'</p>\'+'."\n";
												}
												if ($currentmarker->contact_mobile != "") 
												{
													$scripttext .= '\'<p class="placemarkBodyContact">'.JText::_('MOD_ZHYANDEXMAP_MAP_USER_CONTACT_MOBILE').' '.htmlspecialchars(str_replace('\\', '/', $currentmarker->contact_mobile), ENT_QUOTES, 'UTF-8').'</p>\'+'."\n";
												}
												if ($currentmarker->contact_fax != "") 
												{
													$scripttext .= '\'<p class="placemarkBodyContact">'.JText::_('MOD_ZHYANDEXMAP_MAP_USER_CONTACT_FAX').' '.htmlspecialchars(str_replace('\\', '/', $currentmarker->contact_fax), ENT_QUOTES, 'UTF-8').'</p>\'+'."\n";
												}
											break;
											case 2:
												if ($currentmarker->contact_name != "") 
												...
												if ($currentmarker->contact_address != "") 
												{
													$scripttext .= '\'<p class="placemarkBodyContact"><img src="'.$imgpathUtils.'address.png" alt="'.JText::_('MOD_ZHYANDEXMAP_MAP_USER_CONTACT_ADDRESS').'" />'.str_replace('<br /><br />', '<br />', str_replace(array("\r", "\r\n", "\n"), '<br />', htmlspecialchars(str_replace('\\', '/', $currentmarker->contact_address), ENT_QUOTES, 'UTF-8'))).'</p>\'+'."\n";
												}
												if ($currentmarker->contact_phone != "") 
												{
													$scripttext .= '\'<p class="placemarkBodyContact"><img src="'.$imgpathUtils.'phone.png" alt="'.JText::_('MOD_ZHYANDEXMAP_MAP_USER_CONTACT_PHONE').'" />'.htmlspecialchars(str_replace('\\', '/', $currentmarker->contact_phone), ENT_QUOTES, 'UTF-8').'</p>\'+'."\n";
												}
												if ($currentmarker->contact_mobile != "") 
												{
													$scripttext .= '\'<p class="placemarkBodyContact"><img src="'.$imgpathUtils.'mobile.png" alt="'.JText::_('MOD_ZHYANDEXMAP_MAP_USER_CONTACT_MOBILE').'" />'.htmlspecialchars(str_replace('\\', '/', $currentmarker->contact_mobile), ENT_QUOTES, 'UTF-8').'</p>\'+'."\n";
												}
												if ($currentmarker->contact_fax != "") 
												{
													$scripttext .= '\'<p class="placemarkBodyContact"><img src="'.$imgpathUtils.'fax.png" alt="'.JText::_('MOD_ZHYANDEXMAP_MAP_USER_CONTACT_FAX').'" />'.htmlspecialchars(str_replace('\\', '/', $currentmarker->contact_fax), ENT_QUOTES, 'UTF-8').'</p>\'+'."\n";
												}
											break;
											case 3:
												if ($currentmarker->contact_name != "") 
					...
					else
					{
						...
						//$scripttext .= '    \'<br />\'+' ."\n";
						//$scripttext .= '    \''.JText::_( 'MOD_ZHYANDEXMAP_MAP_USER_LNG' ).' \'+current.getLng() + ' ."\n";
						//$scripttext .= '    \'<br />'.JText::_( 'MOD_ZHYANDEXMAP_MAP_USER_LAT' ).' \'+current.getLat() + ' ."\n";
						// Form Update
						...
						$scripttext .= '\'<a id="bodyInsertPlacemarkA'.$currentmarker->id.'" href="javascript:showonlyone(\\\'Placemark\\\',\\\''.$currentmarker->id.'\\\');" ><img src="'.$imgpathUtils.'collapse.png">'.JText::_( 'MOD_ZHYANDEXMAP_MAP_USER_BASIC_PROPERTIES' ).'</a>\'+'."\n";
						$scripttext .= '\'</div>\'+'."\n";
						...
						if (isset($map->showbelong) && (int)$map->showbelong == 1)
						{
							...
							$scripttext .= '\'<a id="bodyInsertPlacemarkGrpA'.$currentmarker->id.'" href="javascript:showonlyone(\\\'PlacemarkGroup\\\',\\\''.$currentmarker->id.'\\\');" ><img src="'.$imgpathUtils.'expand.png">'.JText::_( 'MOD_ZHYANDEXMAP_MAP_USER_BASIC_GROUP_PROPERTIES' ).'</a>\'+'."\n";
							$scripttext .= '\'</div>\'+'."\n";
							$scripttext .= '\'<div id="bodyInsertPlacemarkGrp'.$currentmarker->id.'"  class="bodyInsertPlacemarkGrpProperties">\'+'."\n";
								...
								{
									$scripttext .= '    \' <option value="">'.JText::_( 'MOD_ZHYANDEXMAP_MAPMARKER_FILTER_PLACEMARK_GROUP').'</option> \'+' ."\n";
								}
								foreach ($newMarkerGroupList as $key => $newGrp) 
								{
						...
						if (isset($map->usercontact) && (int)$map->usercontact == 1) 
						{
								...
								$scripttext .= '\'<a id="bodyInsertContactA'.$currentmarker->id.'" href="javascript:showonlyone(\\\'Contact\\\',\\\''.$currentmarker->id.'\\\');" ><img src="'.$imgpathUtils.'expand.png">'.JText::_( 'MOD_ZHYANDEXMAP_MAP_USER_CONTACT_PROPERTIES' ).'</a>\'+'."\n";
								$scripttext .= '\'</div>\'+'."\n";
								...
								$scripttext .= '\'<a id="bodyInsertContactAdrA'.$currentmarker->id.'" href="javascript:showonlyone(\\\'ContactAddress\\\',\\\''.$currentmarker->id.'\\\');" ><img src="'.$imgpathUtils.'expand.png">'.JText::_( 'MOD_ZHYANDEXMAP_MAP_USER_CONTACT_ADDRESS_PROPERTIES' ).'</a>\'+'."\n";
								$scripttext .= '\'</div>\'+'."\n";
						...
						$scripttext .= '    \'<input name="markersubmit" type="submit" value="'.JText::_( 'MOD_ZHYANDEXMAP_MAP_USER_BUTTON_UPDATE' ).'" />\'+' ."\n";
						$scripttext .= '    \'</form>\'+' ."\n";		
						$scripttext .= '\'</div>\'+'."\n";
						// Form Delete
						...
						$scripttext .= '    \'<input name="markerid" type="hidden" value="'.$currentmarker->id.'" />\'+' ."\n";
						$scripttext .= '    \'<input name="contactid" type="hidden" value="'.$currentmarker->contactid.'" />\'+' ."\n";
						$scripttext .= '    \'<input name="markersubmit" type="submit" value="'.JText::_( 'MOD_ZHYANDEXMAP_MAP_USER_BUTTON_DELETE' ).'" />\'+' ."\n";
						$scripttext .= '    \'</form>\'+' ."\n";		
						$scripttext .= '\'</div>\';'."\n";
	...
	if (isset($routers) && !empty($routers)) 
	{
		...
		foreach ($routers as $key => $currentrouter) 
		{
			...
			if ($currentrouter->route != "")
			{
				$scripttext .= 'ymaps.route(['.$currentrouter->route.'],'."\n";
					...
					if (isset($currentrouter->showpanel) && (int)$currentrouter->showpanel == 1) 
					{
						...
						$scripttext .= '         {'."\n";
						$scripttext .= '        	 moveList += segCounter + \' '.JText::_('MOD_ZHYANDEXMAP_MAP_FIND_GEOCODING_START_POINT').'</br>\';'."\n";
						$scripttext .= '         }'."\n";
						$scripttext .= '         else'."\n";
						$scripttext .= '         {'."\n";
						$scripttext .= '         	moveList += segCounter + \' '.JText::_('MOD_ZHYANDEXMAP_MAP_FIND_GEOCODING_WAY_POINT').'</br>\';'."\n";
						$scripttext .= '         }'."\n";
						...
						$scripttext .= '         moveList += \'';
						$scripttext .= JText::_('MOD_ZHYANDEXMAP_MAPROUTER_DETAIL_SHOWPANEL_HDR_TOTAL_KM');
						$scripttext .= ' \'+ total_km + \' ';
						//$scripttext .= JText::_('MOD_ZHYANDEXMAP_MAPROUTER_DETAIL_SHOWPANEL_HDR_KM');
						$scripttext .= ', ';
						$scripttext .= JText::_('MOD_ZHYANDEXMAP_MAPROUTER_DETAIL_SHOWPANEL_HDR_TOTAL_TIME');
						if (isset($currentrouter->checktraffic) && (int)$currentrouter->checktraffic == 1)
						{
							$scripttext .= ' '.JText::_('MOD_ZHYANDEXMAP_MAPROUTER_DETAIL_SHOWPANEL_HDR_JAM');
						}
						$scripttext .= ' \' + total_time;';
						//$scripttext .= JText::_('MOD_ZHYANDEXMAP_MAPROUTER_DETAIL_SHOWPANEL_HDR_TIME');
						$scripttext .= '         moveList += \'</td>\''."\n";
						$scripttext .= '         moveList += \'</tr>\''."\n";
						...
						$scripttext .= '         moveList += \''.JText::_('MOD_ZHYANDEXMAP_MAP_FIND_GEOCODING_MOVE').' <b>\' + segments[i].getHumanAction() + \'</b>\'+(street ? \' '.JText::_('MOD_ZHYANDEXMAP_MAP_FIND_GEOCODING_ON').' <b>\' + street + \'</b>\': \'\');'."\n";
						$scripttext .= '         moveList += \'</td>\''."\n";
						$scripttext .= '         moveList += \'<td class="zhym-route-table-td">\''."\n";
						...
						$scripttext .= '         	moveList += segmentlength.toFixed(1) + \' '.JText::_('MOD_ZHYANDEXMAP_MAP_FIND_GEOCODING_KILOMETERS').'\';'."\n";
						$scripttext .= '         }'."\n";
						$scripttext .= '         else'."\n";
						$scripttext .= '         {'."\n";
						$scripttext .= '         	moveList += segmentlength.toFixed(0) + \' '.JText::_('MOD_ZHYANDEXMAP_MAP_FIND_GEOCODING_METERS').'\';'."\n";
						$scripttext .= '         }'."\n";
						$scripttext .= '         moveList += \'</td>\''."\n";
						$scripttext .= '         moveList += \'</tr>\''."\n";
						$scripttext .= '       }'."\n";
						...
						$scripttext .= '         moveList += \'<td class="zhym-route-table-td-waypoint" colspan="2">\''."\n";
						$scripttext .= '         segCounter += 1;'."\n";
						$scripttext .= '      moveList += segCounter + \' '.JText::_('MOD_ZHYANDEXMAP_MAP_FIND_GEOCODING_END_POINT').'\';'."\n";
						$scripttext .= '         moveList += \'</td>\''."\n";
						$scripttext .= '         moveList += \'</tr>\''."\n";
					...
					$scripttext .= '     alert(\''.JText::_('MOD_ZHYANDEXMAP_MAP_ERROR_GEOCODING').'\' + '.$routererror.'.message);'."\n";
					$scripttext .= '  }'."\n";
					$scripttext .= ');'."\n";
			...
			if ($currentrouter->routebymarker != "")
			{
				...
				{	
					...
					if ($currouteLatLng != "")
					{
						...
						{
							$scripttext .= 'alert(\''.JText::_('MOD_ZHYANDEXMAP_MAPROUTER_FINDMARKER_ERROR_GEOCODE').' '.$curroute.'\');'."\n";
							$skipRouteCreation = 1;
						}
						else
						{
					...
					{
						$scripttext .= 'alert(\''.JText::_('MOD_ZHYANDEXMAP_MAPROUTER_FINDMARKER_ERROR_REASON').' '.$curroute.'\');'."\n";
						$skipRouteCreation = 1;
					}
				...
				if ($skipRouteCreation == 0)
				{
					...
					$scripttext .= '     alert(\''.JText::_('MOD_ZHYANDEXMAP_MAP_ERROR_GEOCODING').'\' + '.$router2error.'.message);'."\n";
					$scripttext .= '  }'."\n";
					$scripttext .= ');'."\n";
			...
			if ($currentrouter->kmllayerymapsml != "")
			{
				...
				$scripttext .= '    alert(\''.JText::_('MOD_ZHYANDEXMAP_MAP_ERROR_YMAPSML').'\' + error.message);' ."\n";
				$scripttext .= '	}' ."\n";
				$scripttext .= ');	' ."\n";
			}
			...
			if ($currentrouter->kmllayerkml != "")
			{
				...
				$scripttext .= '	},' ."\n";
				$scripttext .= '	function(error) {' ."\n";
				$scripttext .= '    alert(\''.JText::_('MOD_ZHYANDEXMAP_MAP_ERROR_KML').'\' + error.message);' ."\n";
				$scripttext .= '	}' ."\n";
				$scripttext .= ');	' ."\n";
			}
			...
			if ($currentrouter->kmllayergpx != "")
			{
				...
				$scripttext .= '	},' ."\n";
				$scripttext .= '	function(error) {' ."\n";
				$scripttext .= '    alert(\''.JText::_('MOD_ZHYANDEXMAP_MAP_ERROR_GPX').'\' + error.message);' ."\n";
				$scripttext .= '	}' ."\n";
				$scripttext .= ');	' ."\n";
			}
...
// Find option Begin
	if (isset($map->findcontrol) && (int)$map->findcontrol == 1) 
	{
		...
		$scripttext .= '		else ' ."\n";
		$scripttext .= '		{' ."\n";
        $scripttext .= '            alert("'.JText::_('MOD_ZHYANDEXMAP_MAP_ERROR_FIND_GEOCODING').'");' ."\n";
        $scripttext .= '        }' ."\n";
        $scripttext .= '    },' ."\n";

        // Failure geocoding
        $scripttext .= '    function (err) {' ."\n";
        $scripttext .= '        alert("'.JText::_('MOD_ZHYANDEXMAP_MAP_ERROR_FIND_GEOCODING_ERROR').'" + err.message);' ."\n";
        $scripttext .= '    });' ."\n";
        $scripttext .= '};' ."\n";
	}
// Find option End
...
// Add Map Route
		if (isset($map->findroute) && (int)$map->findroute == 1) 
		{
			...
			$scripttext .= '    points.get(0).properties.set(\'iconContent\', \''.JText::_('MOD_ZHYANDEXMAP_MAP_FIND_GEOCODING_START_POINT').'\');'."\n";
			$scripttext .= '    points.get(1).properties.set(\'iconContent\', \''.JText::_('MOD_ZHYANDEXMAP_MAP_FIND_GEOCODING_END_POINT').'\');'."\n";
			...
			$scripttext .= '  }, '."\n";
			$scripttext .= '  function(err){'."\n";
			$scripttext .= '     alert(\''.JText::_('MOD_ZHYANDEXMAP_MAP_ERROR_GEOCODING').'\' + err.message);'."\n";
			$scripttext .= '  }'."\n";
			$scripttext .= ');'."\n";
			$scripttext .= '}'."\n";
		}
...
if (isset($map->usermarkers) && (int)$map->usermarkers == 1) 
{
    if ($allowUserMarker == 1)
    {
			...
			$scripttext .= '    xPlacemarkA.innerHTML = \'<img src="'.$imgpathUtils.'expand.png">'.JText::_( 'MOD_ZHYANDEXMAP_MAP_USER_BASIC_PROPERTIES' ).'\';'."\n";
			if (isset($map->usercontact) && (int)$map->usercontact == 1)
			{
				$scripttext .= '    toHide = document.getElementById("bodyInsertContactAdr"+theid);'."\n";
				$scripttext .= '    toHide.style.display = \'none\';'."\n";
				$scripttext .= '    xContactAdrA.innerHTML = \'<img src="'.$imgpathUtils.'expand.png">'.JText::_( 'MOD_ZHYANDEXMAP_MAP_USER_CONTACT_ADDRESS_PROPERTIES' ).'\';'."\n";
				$scripttext .= '    toShow = document.getElementById("bodyInsertContact"+theid);'."\n";
				$scripttext .= '    toShow.style.display = \'block\';'."\n";
				$scripttext .= '    xContactA.innerHTML = \'<img src="'.$imgpathUtils.'collapse.png">'.JText::_( 'MOD_ZHYANDEXMAP_MAP_USER_CONTACT_PROPERTIES' ).'\';'."\n";
			}
			if (isset($map->showbelong) && (int)$map->showbelong == 1)
			{
				$scripttext .= '    toHide = document.getElementById("bodyInsertPlacemarkGrp"+theid);'."\n";
				$scripttext .= '    toHide.style.display = \'none\';'."\n";
				$scripttext .= '    xPlacemarkGrpA.innerHTML = \'<img src="'.$imgpathUtils.'expand.png">'.JText::_( 'MOD_ZHYANDEXMAP_MAP_USER_BASIC_GROUP_PROPERTIES' ).'\';'."\n";
			}
			$scripttext .= '  }'."\n";
			...
			$scripttext .= '    toShow.style.display = \'block\';'."\n";
			$scripttext .= '    xPlacemarkA.innerHTML = \'<img src="'.$imgpathUtils.'collapse.png">'.JText::_( 'MOD_ZHYANDEXMAP_MAP_USER_BASIC_PROPERTIES' ).'\';'."\n";
			if (isset($map->usercontact) && (int)$map->usercontact == 1)
			{
				...
				$scripttext .= '    toHide = document.getElementById("bodyInsertContactAdr"+theid);'."\n";
				$scripttext .= '    toHide.style.display = \'none\';'."\n";
				$scripttext .= '    xContactA.innerHTML = \'<img src="'.$imgpathUtils.'expand.png">'.JText::_( 'MOD_ZHYANDEXMAP_MAP_USER_CONTACT_PROPERTIES' ).'\';'."\n";
			}
			if (isset($map->showbelong) && (int)$map->showbelong == 1)
			{
				$scripttext .= '    toHide = document.getElementById("bodyInsertPlacemarkGrp"+theid);'."\n";
			...
			if (isset($map->showbelong) && (int)$map->showbelong == 1)
			{
				...
				$scripttext .= '    toShow.style.display = \'block\';'."\n";
				$scripttext .= '    xPlacemarkGrpA.innerHTML = \'<img src="'.$imgpathUtils.'collapse.png">'.JText::_( 'MOD_ZHYANDEXMAP_MAP_USER_BASIC_GROUP_PROPERTIES' ).'\';'."\n";
			}
			$scripttext .= '  }'."\n";
			...
			{
				$scripttext .= '    xContactA.innerHTML = \'<img src="'.$imgpathUtils.'expand.png">'.JText::_( 'MOD_ZHYANDEXMAP_MAP_USER_CONTACT_PROPERTIES' ).'\';'."\n";
				$scripttext .= '    xContactAdrA.innerHTML = \'<img src="'.$imgpathUtils.'collapse.png">'.JText::_( 'MOD_ZHYANDEXMAP_MAP_USER_CONTACT_ADDRESS_PROPERTIES' ).'\';'."\n";
			}
			$scripttext .= '  }'."\n";
			$scripttext .= '}'."\n";
    }   
