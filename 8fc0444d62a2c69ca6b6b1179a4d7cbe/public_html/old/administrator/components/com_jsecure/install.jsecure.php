 ...
 */
	...
	$r4 = true === JFile::move( JPATH_ADMINISTRATOR. DS.'components'.DS.'com_jsecure'.DS.'sysplugin'.DS.'index.html',
	JPATH_ROOT.DS.'plugins'.DS.'system'.DS.'jsecure'.DS.'index.html');
	...
	JFile::move( JPATH_ADMINISTRATOR.DS.'components'.DS.'com_jsecure'.DS.'sysplugin'.DS.'jsecure'.DS.'index.html', JPATH_ROOT.DS.'plugins'.DS.'system'.DS.'jsecure'.DS.'jsecure'.DS.'index.html');
	...
	JFile::move( JPATH_ADMINISTRATOR.DS.'components'.DS.'com_jsecure'.DS.'sysplugin'.DS.'jsecure'.DS.'css'.DS.'index.html', JPATH_ROOT.DS.'plugins'.DS.'system'.DS.'jsecure'.DS.'jsecure'.DS.'css'.DS.'index.html');
