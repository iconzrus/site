...
// remove system plugin
	...
	JFile::delete(JPATH_ROOT.DS.'plugins'.DS.'system'.DS.'jsecure'.DS.'index.html'); 
	...
	JFile::delete(JPATH_ROOT.DS.'plugins'.DS.'system'.DS.'jsecure'.DS.'jsecure'.DS.'index.html');
	JFile::delete(JPATH_ROOT.DS.'plugins'.DS.'system'.DS.'jsecure'.DS.'jsecure'.DS.'css'.DS.'jsecure.css');
	JFile::delete(JPATH_ROOT.DS.'plugins'.DS.'system'.DS.'jsecure'.DS.'jsecure'.DS.'css'.DS.'index.html');
