...
/**
 * ZhYandex MapMarker View
 */
class ZhYandexMapViewMapMarker extends JView
{
	/**
	 * display method of ZhYandex MapMarker view
	 * @return void
	 */
	...
	protected function addToolBar() 
	{
		...
		$canDo = ZhYandexMapHelper::getMarkerActions($this->item->id);
		JToolBarHelper::title($isNew ? JText::_('COM_ZHYANDEXMAP_MAPMARKER_NEW') : JText::_('COM_ZHYANDEXMAP_MAPMARKER_EDIT'), 'mapmarker');
	...
	protected function setDocument() 
	{
		...
		$document->setTitle($isNew ? JText::_('COM_ZHYANDEXMAP_ADMINISTRATION_MAPMARKER_CREATING') : JText::_('COM_ZHYANDEXMAP_ADMINISTRATION_MAPMARKER_EDITING'));
		$document->addScript(JURI::root() . $this->script);
		$document->addScript(JURI::root() . "administrator/components/com_zhyandexmap/views/mapmarker/submitbutton.js");
		JText::script('COM_ZHYANDEXMAP_MAPMARKER_ERROR_UNACCEPTABLE');
	}
}
